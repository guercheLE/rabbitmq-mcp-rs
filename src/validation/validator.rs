...
fn schemas_zst_for(api_version: &str) -> Option<&'static [u8]> {
    match api_version {
        "4.3.2" => Some(include_bytes!("generated_schemas.json.zst")),
        "4.2.8" => Some(include_bytes!("generated_schemas_v4.2.8.json.zst")),
        "4.1.8" => Some(include_bytes!("generated_schemas_v4.1.8.json.zst")),
        "4.0.9" => Some(include_bytes!("generated_schemas_v4.0.9.json.zst")),
        "3.13.7" => Some(include_bytes!("generated_schemas_v3.13.7.json.zst")),
        _ => None,
    }
}
// mcpify:versions:end
...
mod tests {
    ...
    fn an_unknown_operation_id_falls_back_to_an_always_valid_schema() {
        ...
        assert!(validate_output("4.3.2", "__unknown_operation__", &serde_json::json!(42)).is_ok());
    }
