...
use rabbitmq_mcp::core::api_url_builder::build_api_url;
use rabbitmq_mcp::core::config_manager::load_config;
use rabbitmq_mcp::core::config_schema::Transport;

async fn probe(
    config: &rabbitmq_mcp::core::config_schema::Config,
...
mod tests {
    ...
    fn config(url: String) -> rabbitmq_mcp::core::config_schema::Config {
